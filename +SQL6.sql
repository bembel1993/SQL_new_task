...
DECLARE @COMPANY VARCHAR(25) = 'Jones Mfg.'
...
DECLARE @REP INT = DBO.COUNT_ORDERS_OF_SALESREPS(108, '2008-02-02', '2008-02-15')
...
END TRY
BEGIN CATCH
	SET @DEFINITE_ORDER_DATE = -1
	PRINT 'NOT FOUND SALESREPS'
END CATCH
	RETURN @DEFINITE_ORDER_DATE
END
----CALL PROCEDURE------
